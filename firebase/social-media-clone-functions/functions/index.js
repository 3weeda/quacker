...
const { signup, login, uploadImage, addUserDetails, addAuthenticatedUser, getUserDetails, markNotificationsRead } = require('./handlers/users');
...
app.get('/user', FBAuth, addAuthenticatedUser)
...
exports.onUserAvatarChange = functions.region('europe-west1').firestore.document('users/{userId}')
    .onUpdate(change => {
